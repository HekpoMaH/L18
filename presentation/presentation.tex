...
\begin{frame}
    ...
    \only<2>{
        \begin{equation*}
            f_i=\alert{\frac{w_i}{n_i}}+c\cdot p_i \cdot \sqrt{\frac{\ln N_i}{n_i}}
        \end{equation*}
    }
    \only<3>{
        \begin{equation*}
            f_i=\frac{w_i}{n_i}+\alert{c\cdot p_i \cdot \sqrt{\frac{\ln N_i}{n_i}}}
        \end{equation*}
    }
    \column{.40\textwidth}
    \begin{itemize}
...
\begin{frame}
    ...
    \end{figure}
    \end{columns}
    \footnotetext[3]{Example and picture from \cite{Enigma}}
